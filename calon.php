...
<body>
  <nav style="height: 60px!important;">
    <div class="nav-wrapper">
      ...
      <a href="logout.php" class="brand-logo nav-link logout"><img src="../admin/img/Polinema.png" width="60" height="60" alt="">
        <img src="../admin/img/Formadiksi2.png" width="60" height="60" alt=""></a>
  ...
  <!-- <ul class="sidenav" id="mobile-demo">
	 <li><div class="user-view">
	      ...
	      <a href="#user"><img class="circle" src="../epemilu/admin/img/Formadiksi2.png"></a>
                ...
                <div class="card large">
                  <div class="card-image">
                    ...
                    <span class="card-title" style="padding: 0px">
                      <div class="card-panel light-blue" style="margin: 0px;padding: 12px!important;"><?php echo $pilca['no']; ?></div>
                    </span>
                    <!-- Modal Trigger -->
