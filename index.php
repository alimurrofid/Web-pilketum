...
<!-- Tabs Titles -->
    <h2 class="active" style="width: 100%;margin: 30 0 20 0;padding: 0;"><p style="font-size: 25;font-family: monospace;line-height: 1; margin: 0;">Selamat Datang<br>Pemilihan Ketua Umum <br>Formadiksi Polinema <br>2023/2024<br></p></h2>
    <!-- Icon -->
    <div class="fadeIn first" align="center">
     <img src="admin/img/Formadiksi2.png" id="icon" alt="User Icon" height="" width="" />
    </div>
    <!--<h2 class="active"><font size="" >"Gunakan hak pilih anda, Untuk Formadiksi Polinema Yang Lebih Baik"</font></h2>-->
    <!--<h2 class="active"><font size="">TERIMA KASIH </br>TELAH MEMILIH &#x1F970</font></h2>-->
...
<br>
    ...
    <form action="" id="frm_login" method="post" enctype="multipart/form-data" >
      ...
      <a href="http://pilketumformadiksipolinema.42web.io/admin/login.php" target="blank">Login Admin</a>
    </form>
